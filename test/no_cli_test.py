...
class TestForward(unittest.TestCase):
    ...
    def test_forward_run(self):
        ...
        forward = Forward(
            worker=4, script=self.test_script, args={},
            loglevel='INFO', logfile=self.test_log,
            no_std_log=True, out='txt', outfile=self.test_out,
            inventory=['127.0.0.1', '192.168.182.14', '192.168.182.16'],
            vender='bclinux7', model='bclinux7', connect='ssh',
            conpass='111111', actpass='',
            remote_port=22, remote_user='maiyifan', timeout=2)
        result = forward.run()
