...
setup(
    ...
    description='A CLI based batch device operation Python module',
    # long_description=long_description,

    # The project's main homepage.
    url='https://git.oschina.net/headkarl/Forwarder',

    # Author details
    author=__author__,
    author_email='azrael-ex@139.com',
